...
extern uint64 sys_score_reset(void);
extern uint64 sys_score_inc(void);
extern uint64 sys_score_get(void);
...
[SYS_score_reset]     sys_score_reset,
[SYS_score_inc]       sys_score_inc,
[SYS_score_get]       sys_score_get,
};
